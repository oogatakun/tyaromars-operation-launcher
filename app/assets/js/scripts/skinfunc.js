...
// チャロマーズランチャー内のスキンのJSONを呼び出し・オブジェクトに変更
function loadSkins() {
...
// 初回時、自分で設定したパスでをチャロマーズランチャーにインポートする
...
// 公式とチャロマーズランチャーJSONのmerge（同期trueの時のみ動かす）
