        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/oogatakun/tyaromars-operation-launcher/releases/download/v${info.version}/tyaromars-operation-launcher-setup-${info.version}.dmg`
                    showUpdateUI(info)
                }
